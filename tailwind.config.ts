	...
	theme: {
		...
		extend: {
			colors: {
				...
				psychedelic: {
					orange: 'hsl(var(--psychedelic-orange))',
					pink: 'hsl(var(--psychedelic-pink))',
					purple: 'hsl(var(--psychedelic-purple))',
					'dark-purple': 'hsl(var(--psychedelic-dark-purple))',
					yellow: 'hsl(var(--psychedelic-yellow))',
					cream: 'hsl(var(--cream))'
				}
			},
			fontFamily: {
